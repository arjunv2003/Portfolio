...
const HeroHeader = () => {
  const text = useTypingEffect(
    ["IITian", "Software Developer", "Web Developer", "ML Enthusiast"],
    100,
    2000
  );
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", gap: "20px", marginTop: "10px" }}>
            <a
              href="https://www.linkedin.com/in/arjun-kanth-venkatagiri-7aba47241/"
              target="_blank"
            ...
            <a
              href="https://www.geeksforgeeks.org/user/20cs01065/"
              target="_blank"
              rel="noopener noreferrer"
            >
