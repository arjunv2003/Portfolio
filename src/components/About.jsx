...
const About = () => {
  return (
    <div className="flex flex-col lg:flex-row items-center lg:items-start justify-center px-6 sm:px-10 py-16 max-w-6xl mx-auto">
      {/* Image Section */}
      <div className="lg:w-1/3 w-full flex justify-center">
        <img
          // src="https://themewagon.github.io/meyawo/assets/imgs/man.png"
        //   src="https://arjunkanth.github.io/ArjunsPortfolio/assets/img/my%20img.jpeg"
        src={myImg}
          alt="Profile"
      ...
      <div className="lg:w-2/3 w-full lg:pl-12 text-center lg:text-left mt-6 lg:mt-0">
        ...
        <h2 className="text-4xl font-bold text-[#695aa6] mb-4" style={{fontFamily: '"Indie Flower", cursive'}}>About Me</h2>
